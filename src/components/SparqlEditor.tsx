import { EditorProps, Editor as MonacoEditor, type Monaco as MonacoInstance, loader } from '@monaco-editor/react';
...
type SparqlEditorProps = Omit<EditorProps, 'defaultLanguage' | 'theme' | 'beforeMount' | 'onMount'>;

export type EditorHandle = Monaco.editor.IStandaloneCodeEditor | undefined;

export const SparqlEditor = forwardRef<Monaco.editor.IStandaloneCodeEditor | undefined, SparqlEditorProps>(
